  ...
  const headerButton = () => {
    return (
      <Button
        variant="ghost"
        className={cn(
          "text-secondary-foreground/80 rounded-md font-normal -ms-2 px-2 h-7 hover:bg-gray-200 data-[state=open]:bg-secondary hover:text-foreground data-[state=open]:text-foreground",
          className
        )}
